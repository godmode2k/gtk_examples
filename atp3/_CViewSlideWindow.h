#ifndef __CVIEWSLIDEWINDOW_H__
#define __CVIEWSLIDEWINDOW_H__
...
// forward reference
class CViewSlideWindow;


// Animation
#include "_incl_slidewindow_anim.hxx"



// Main class
class CViewSlideWindow : virtual public CBaseView {
private:
	const char* TAG;
	char* TAG2;
	...
	// Animation Task
	CSlideWindow_Anim* m_pAnim;
protected:
public:
	// Ctor/Dtor
	explicit CViewSlideWindow(void);
	virtual ~CViewSlideWindow();
