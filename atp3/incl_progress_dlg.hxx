#ifndef __INCL_PROGRESS_DLG_HXX__
#define __INCL_PROGRESS_DLG_HXX__
...
//! Class
// ---------------------------------------------------------------
// "incl_progress_dlg.cxx"
class CProgress_dlg : public CProgressDlg {
private:
	const char* TAG;
protected:
public:
	explicit CProgress_dlg(void);
	~CProgress_dlg();
...
#endif	// __INCL_PROGRESS_DLG_HXX__
